...
capability objects resolved from ``RenderRuntime.extensions``.
"""
...
async def render_html(
    ...
    *,
    ...
    return await resolve_runtime(runtime).renderer.render_html(request)
...
async def render_text(
    ...
    *,
    ...
    return await resolve_runtime(runtime).renderer.render_text(request)
...
async def render_markdown(
    ...
    *,
    ...
    return await resolve_runtime(runtime).renderer.render_markdown(request)
...
async def render_template(
    ...
    *,
    ...
    return await resolve_runtime(runtime).renderer.render_template(request)
...
async def render_template_html(
    ...
    *,
    ...
    return await resolve_runtime(runtime).renderer.render_template_html(request)
...
async def rasterize_html(
    ...
    *,
    ...
    return await resolve_runtime(runtime).renderer.rasterize_html(request)
