"""Typed first-party extensions exposed by a render runtime."""
...
if TYPE_CHECKING:
    from entari_plugin_htmlrender.graphics.ports import RasterSceneRenderer
